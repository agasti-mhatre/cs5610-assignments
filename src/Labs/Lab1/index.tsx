    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-h-tag">
          ...
          For instance this paragraph is preceded by the heading Heading Tags. The font of the section headings are usually larger and bolder than their subsection headings. 
          This document uses headings to introduce topics such as HTML Documents, HTML Tags, Heading Tags, etc. 
          HTML heading tags can be used to format plain text so that it renders in a browser as large headings. There are 6 heading tags for different sizes: h1, h2, h3, h4, h5, and h6. 
          ...
          <div id="wd-images">
            ...
            <div id="wd-forms">
              ...
              <form id="wd-text-fields">
                ...
                <h4>Anchor tag</h4>
                Please
                <a id="wd-github" href="https://github.com/agasti-mhatre/cs5610-assignments/tree/a1">click here</a>
